...
const CaseCard = ({ quote, name, role, result }) => (
  <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
    <Quote className="mb-4 h-6 w-6 text-[#4a91f2]" />
    <p className="text-white/90 leading-relaxed">“{quote}”</p>
    <div className="mt-4 text-sm text-white/70">— {name}, {role}</div>
    <div className="mt-3 rounded-lg bg-green-500/10 p-3 text-sm text-green-300">
      {result}
    </div>
  </div>
);
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-16 grid gap-8 md:grid-cols-3">
          <div className="md:col-span-1">
            ...
            <p className="mt-3 text-white/70">Specific numbers. Real outcomes. Trusted by marketing leaders.</p>
          </div>
        ...
        <div className="grid gap-10 md:grid-cols-2">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mt-3 text-sm leading-relaxed text-white/70">Share a bit about your goals. We’ll map the fastest path to measurable impact.</p>
            <form className="mt-8 space-y-5">
              <div>
                <label className="text-xs text-white/60">Full Name</label>
                <input type="text" className="mt-1 w-full rounded-md border border-white/10 bg-black/40 px-3 py-2.5 text-sm text-white placeholder-white/40 outline-none ring-[#4a91f2]/40 focus:ring" placeholder="Jane Doe" />
              </div>
              <div className="grid gap-5 md:grid-cols-2">
                <div>
                  <label className="text-xs text-white/60">Work Email</label>
                  <input type="email" className="mt-1 w-full rounded-md border border-white/10 bg-black/40 px-3 py-2.5 text-sm text-white placeholder-white/40 outline-none ring-[#4a91f2]/40 focus:ring" placeholder="jane@company.com" />
                </div>
                <div>
                  <label className="text-xs text-white/60">Company</label>
                  <input type="text" className="mt-1 w-full rounded-md border border-white/10 bg-black/40 px-3 py-2.5 text-sm text-white placeholder-white/40 outline-none ring-[#4a91f2]/40 focus:ring" placeholder="Acme SaaS" />
                </div>
              </div>
              <div>
                <label className="text-xs text-white/60">Goal</label>
                <select className="mt-1 w-full rounded-md border border-white/10 bg-black/40 px-3 py-2.5 text-sm text-white outline-none ring-[#4a91f2]/40 focus:ring">
              ...
              <div>
                ...
                <textarea rows={4} className="mt-1 w-full rounded-md border border-white/10 bg-black/40 px-3 py-2.5 text-sm text-white placeholder-white/40 outline-none ring-[#4a91f2]/40 focus:ring" placeholder="Tell us about your product and audience..." />
              </div>
              <button type="submit" className="group inline-flex items-center justify-center rounded-md bg-[#4a91f2] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-[#4a91f2]/30 transition hover:brightness-110">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl bg-gradient-to-r from-[#4a91f2] via-blue-600 to-black p-6 text-white">
