...
const logos = [
  { name: 'Segment', src: 'https://dummyimage.com/120x32/ffffff/000000&text=Segment' },
  { name: 'HubSpot', src: 'https://dummyimage.com/120x32/ffffff/000000&text=HubSpot' },
  { name: 'Datadog', src: 'https://dummyimage.com/120x32/ffffff/000000&text=Datadog' },
  { name: 'Amplitude', src: 'https://dummyimage.com/120x32/ffffff/000000&text=Amplitude' },
];
...
const ProofAndSolutions = () => {
  return (
    <section className="bg-[#0b1220] py-28 text-white">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid items-start gap-14 md:grid-cols-2">
          <div>
            ...
            <p className="mt-4 text-white/70">Contrast that converts: see the before/after impact of animation on key metrics.</p>
            ...
            <div className="mt-8 grid grid-cols-2 gap-5 text-sm">
              ...
              <div className="rounded-xl bg-green-500/10 p-5 text-green-300">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-8 opacity-80">
              {logos.map((l) => (
                <img key={l.name} src={l.src} alt={l.name} className="h-7" />
              ))}
            </div>
          </div>
        ...
        <div className="mt-24 rounded-2xl border border-white/10 bg-gradient-to-br from-[#0b1220] to-black p-8">
          <div className="grid gap-10 md:grid-cols-2">
            <div>
              <h3 className="text-2xl font-bold">Your Animation Department, Without the Overhead</h3>
              <p className="mt-3 text-white/70">Dedicated resources, consistent quality, and a fraction of the cost of hiring in-house.</p>

              <div className="mt-8 grid grid-cols-2 gap-5 text-sm">
                <div className="rounded-xl bg-white/5 p-5">
                  <div className="mb-2 flex items-center gap-2 font-semibold text-white"><Users2 className="h-4 w-4 text-[#4a91f2]"/>In-House Team</div>
                ...
                <div className="rounded-xl bg-white/5 p-5 ring-1 ring-[#4a91f2]/40">
                  <div className="mb-2 flex items-center gap-2 font-semibold text-white"><Gauge className="h-4 w-4 text-[#4a91f2]"/>Our Retainer</div>
                  <ul className="space-y-1 text-white/70">
            ...
            <div className="rounded-2xl bg-white/5 p-6">
              <div className="mb-3 text-xs font-semibold uppercase tracking-wide text-white/60">Process & Scarcity</div>
              ...
              <div className="mt-5 rounded-xl bg-[#4a91f2]/10 p-4 text-[#4a91f2]">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-semibold">Free strategy call — limited slots this month</p>
                  <Clock className="h-4 w-4" />
                </div>
              </div>
              <a href="#contact" className="mt-5 inline-flex items-center justify-center rounded-md bg-[#4a91f2] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-[#4a91f2]/30 hover:brightness-110">Book Your Free Strategy Session</a>
            </div>
          </div>
        </div>
      </div>
